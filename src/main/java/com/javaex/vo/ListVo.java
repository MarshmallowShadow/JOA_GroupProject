...
public class ListVo {
	...
	public ListVo(int boardNo, int userNo, int courseNo, int eventNo, String boardCategory, String title,
	...
	public String toString() {
		return "ListVo [boardNo=" + boardNo + ", userNo=" + userNo + ", courseNo=" + courseNo + ", eventNo=" + eventNo
